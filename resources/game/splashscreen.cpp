...
void RenderSplash()
{
	...
	Draw(&rect, colors[2][1], splashTexture->raster, &uv);
...
void RenderSplashScreen()
{
	...
	ImGui::GetOverlayDrawList()->AddText(ImVec2(0, 0), colors[2][1], 
		"\n\t"
		u8"IGTASAMP_build69 [2019.5.18 19:28Compiled]\n\t"
		u8"国服官网:http://www.igtasamp.cn\n\t"
		u8"国服论坛:http://forum.igtasamp.cn\n\t"
		u8"支持国服:http://u6.gg/szgVe\n\t"
		u8"客户端问题解决/反馈:http://u6.gg/s2yp6"
		);
